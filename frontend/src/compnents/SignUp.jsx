    ...
    return (
        <>
            <div className="h-[70vh] w-full flex flex-col items-center gap-4">
                ...
                <form className="flex flex-col gap-4 w-full max-w-sm mt-4 mx-auto" onSubmit={handleSumbit}>
                ...
                />
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="mt-2 bg-orange-600 text-white py-2 rounded hover:bg-orange-700 acti  ve:bg-orange-800 transition-colors"
                    >
                        {isLoading ? "Creating acccount..." : "Sign Up"}
                    </button>
                    <button
                        type="button"
                    ...
                    {isSuccess && <p className="text-green-600 text-sm text-center font-medium">Registration successful!</p>}
